...
(function () {
    ...
    function ContactsCtrl($scope, $lcmaGrid, $lcmAlert, $lcmaDialog, $lcmaGridFilter, $uibModal, $lcmaPager, $lcmaPage, $lcmaConfirmation, $timeout, Contact) {

        $lcmaPage.setTitle('Contact List');

        $lcmaConfirmation.setFormId('ContactForm');
        $lcmaConfirmation.setFormName('ContactForm');
        ...
        _this.contactQuery = {
          ...
          orderBy: [['company', 'ASC'], ['last_name', 'ASC'], ['first_name', 'ASC']]
        };
        ...
        $scope.removeContact = _this.removeContact = function (contact, index) {
            ...
            var contact = _this.gridApi.selection.getSelectedRows()[0];

            $lcmaDialog.remove({
                message: ' Contact ' + contact.first_name + ' ' + contact.last_name
        ...
        _this.onChange = function(data, create) {
            ...
            if (create) {
                ...
                $lcmAlert.success('Contact Building has been created');
                ...
                $lcmAlert.success('Contact has been updated');
