                            ...
                            return {
                                ...
                                post: function ($scope, $elm, $attrs, controllers) {
                                    var setCorrectPosition = function () {
                                        ...
                                        var setCorrectTopPositionInGrid = function () {
                                            ...
                                            if (freePixelsOnBottom >= requiredPixels && freePixelsOnTop >= requiredPixels) {
                                                ...
                                                topPosition = cellPosition.offset.top - freePixelsOnTop + 20;
                                            } else {
                                        ...
                                        var setCorrectTopPositionInWindow = function () {
                                            ...
                                            if (freePixelsOnBottom >= requiredPixels && freePixelsOnTop >= requiredPixels) {
                                                ...
                                                topPosition = windowHeight - datepickerPosition.height;
                                            }
                                            return topPosition;
                                        };
                                        ...
                                        if (isFreeOnRight) {
                                            newOffsetValues.left = cellPosition.offset.left + cellPosition.width + 20;
                                        } else {
                                        ...
                                        datepickerElement.css("left", newOffsetValues.left+"px");
                                        datepickerElement.css("top", newOffsetValues.top+"px");
                                        datepickerElement.css("z-index", 3000);
                                    ...
                                    if(!$scope.row.entity[$scope.col.field]){
                                        $scope.row.entity[$scope.col.field] = new Date();
                                    }
